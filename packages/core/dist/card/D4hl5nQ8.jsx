...
function CardRoot(props) {
	...
	return <CardContext value={context}>
			<Polymorphic as="div" id={mergedProps.id} aria-labelledby={titleId()} aria-describedby={descriptionId()} {...others} />
		</CardContext>;
}
//#endregion
...
function CardTitle(props) {
	...
	return <Polymorphic as="h3" id={mergedProps.id} {...others} />;
}
//#endregion
