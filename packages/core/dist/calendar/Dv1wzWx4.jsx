...
import { createDateFormatter, getReadingDirection, useLocale } from "../i18n/index.jsx";
...
function CalendarGrid(props) {
	...
	return <CalendarGridContext value={context}>
			<Polymorphic as="table" role="grid" aria-readonly={rootContext.isReadOnly() ? "true" : void 0} aria-disabled={rootContext.isDisabled() ? "true" : void 0} aria-multiselectable={rootContext.selectionMode() !== "single" ? "true" : "false"} {...others} aria-label={ariaLabel()} onKeyDown={onKeyDown} onFocusIn={onFocusIn} onFocusOut={onFocusOut} />
		</CalendarGridContext>;
}
//#endregion
...
function CalendarGridBodyCell(props) {
	...
	return <CalendarGridBodyCellContext value={context}>
			<Polymorphic as="td" role="gridcell" aria-disabled={!isSelectable() ? "true" : void 0} aria-selected={isSelected() ? "true" : void 0} aria-invalid={isInvalid() ? "true" : void 0} aria-current={isDateToday() ? "date" : void 0} data-value={toLocalISOString(props.date, "day")} {...others} />
...
function CalendarGridBodyCellTrigger(props) {
	...
	return <Polymorphic as="div" ref={[setRef, p.ref]} role="button" tabIndex={tabIndex()} aria-disabled={!context.isSelectable() ? "true" : void 0} aria-invalid={context.isInvalid() ? "true" : void 0} aria-label={ariaLabel()} data-disabled={isDisabled() ? "" : void 0} data-invalid={context.isInvalid() ? "" : void 0} data-selected={context.isSelected() ? "" : void 0} data-value={toLocalISOString(context.date(), "day")} data-type="day" data-today={context.isDateToday() ? "" : void 0} data-weekend={isDateWeekend() ? "" : void 0} data-highlighted={context.isFocused() ? "" : void 0} data-unavailable={context.isUnavailable() ? "" : void 0} data-selection-start={isSelectionStart() ? "" : void 0} data-selection-end={isSelectionEnd() ? "" : void 0} data-outside-visible-range={isOutsideVisibleRange() ? "" : void 0} data-outside-month={isOutsideMonth() ? "" : void 0} {...others} disabled={isDisabled()} onClick={onClick} onKeyDown={onKeyDown} onFocus={onFocus}>
			{formattedDate()}
		</Polymorphic>;
}
//#endregion
...
function CalendarNextTrigger(props) {
	...
	return <button_exports.Root disabled={nextTriggerDisabled()} aria-label={context.translations().next} {...others} onClick={onClick} onFocus={onFocus} onBlur={onBlur} />;
}
//#endregion
...
function CalendarPrevTrigger(props) {
	...
	return <button_exports.Root disabled={prevTriggerDisabled()} aria-label={context.translations().previous} {...others} onClick={onClick} onFocus={onFocus} onBlur={onBlur} />;
}
//#endregion
...
function CalendarRoot(props) {
	...
	return <CalendarContext value={context}>
			<Polymorphic as="div" ref={[setRef, mergedProps.ref]} role="group" {...dataset()} {...others} aria-label={ariaLabel()} />
		</CalendarContext>;
}
//#endregion
