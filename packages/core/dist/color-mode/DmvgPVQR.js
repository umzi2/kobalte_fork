import { createComponent, effect, isServer, setAttribute, template } from "@solidjs/web";
...
function ColorModeProvider(props) {
	...
	return createComponent(ColorModeContext, {
		value: {
			colorMode,
			setColorMode,
			toggleColorMode
...
function ColorModeScript(props) {
	...
	effect(() => ({
		...
		e !== _p$?.e && setAttribute(_el$, "nonce", e);
		t !== _p$?.t && (_el$.innerHTML = t);
	});
	return _el$;
}
//#endregion
