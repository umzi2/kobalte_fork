...
import { a as DialogRoot, c as DialogDescription, d as useDialogContext, i as DialogTitle, l as DialogContent, o as DialogPortal, r as DialogTrigger, s as DialogOverlay, u as DialogCloseButton } from "../dialog/Dqui1AYx.jsx";
...
function DrawerContent(props) {
	...
	return <DialogContent ref={p.ref} style={combineStyle({
		transform: transformValue(),
		"transition-duration": ctx.isDragging() ? "0ms" : void 0
	}, p.style)} onPointerDown={onPointerDown} onTouchStart={onTouchStart} onTransitionEnd={onTransitionEnd} data-side={ctx.side()} data-opening={ctx.transitionState() === "opening" ? "" : void 0} data-closing={ctx.transitionState() === "closing" ? "" : void 0} data-snapping={ctx.transitionState() === "snapping" ? "" : void 0} data-transitioning={ctx.isTransitioning() ? "" : void 0} {...others} />;
}
//#endregion
...
function DrawerOverlay(props) {
	...
	return <DialogOverlay data-closing={ctx.transitionState() === "closing" ? "" : void 0} data-transitioning={ctx.isTransitioning() ? "" : void 0} {...omit(p, "style")} style={computedStyle()} />;
}
//#endregion
...
function DrawerRoot(props) {
	...
	return <DialogRoot {...dialogProps} open={transitionAwareOpen()} onOpenChange={handleDialogOpenChange}>
