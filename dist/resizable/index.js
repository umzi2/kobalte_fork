...
import { createComponent, effect, insert, memo, mergeProps, ref, setStyleProperty, spread, template } from "@solidjs/web";
...
var _tmpl$$2 = /*#__PURE__*/ template(`<div data-kb-resizable-handle-start-intersection style="position:absolute;aspect-ratio:1 / 1;top:0;left:0;z-index:1">`);
var _tmpl$2 = /*#__PURE__*/ template(`<div data-kb-resizable-handle-end-intersection style="position:absolute;aspect-ratio:1 / 1;bottom:0;right:0;z-index:1">`);
...
function ResizableHandle(props) {
	...
	const [ref$3, setRef] = createSignal(null);
	...
	var _el$ = _tmpl$3(), _el$4 = _el$.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.nextSibling;
	ref(() => [setRef, p.ref], _el$);
	...
	insert(_el$, createComponent(Show, {
		...
		get children() {
			...
			_el$2.addEventListener("mouseleave", (e) => {
				if (ref$3()?.contains(e.relatedTarget)) setHovered("handle");
				else setHovered(null);
			});
			_el$2.addEventListener("mouseenter", () => setHovered("startIntersection"));
			effect(() => ({
				e: context.orientation() === "horizontal" ? void 0 : "100%",
				t: context.orientation() === "horizontal" ? "100%" : void 0,
				a: context.orientation() === "horizontal" ? "translate3d(0, -100%, 0)" : "translate3d(-100%, 0, 0)"
			}), ({ e, t, a }, _p$) => {
				e !== _p$?.e && setStyleProperty(_el$2, "height", e);
				t !== _p$?.t && setStyleProperty(_el$2, "width", t);
				a !== _p$?.a && setStyleProperty(_el$2, "transform", a);
			});
			return _el$2;
		}
	}), _el$4);
	insert(_el$, () => p.children, _el$5);
	insert(_el$, createComponent(Show, {
		get when() {
		...
		get children() {
			...
			_el$3.addEventListener("mouseenter", () => setHovered("endIntersection"));
			effect(() => ({
				e: context.orientation() === "horizontal" ? void 0 : "100%",
				t: context.orientation() === "horizontal" ? "100%" : void 0,
				a: context.orientation() === "horizontal" ? "translate3d(0, 100%, 0)" : "translate3d(100%, 0, 0)"
			}), ({ e, t, a }, _p$) => {
				e !== _p$?.e && setStyleProperty(_el$3, "height", e);
				t !== _p$?.t && setStyleProperty(_el$3, "width", t);
				a !== _p$?.a && setStyleProperty(_el$3, "transform", a);
			});
			return _el$3;
		}
	}), _el$6);
...
function ResizablePanel(props) {
	...
	const [ref$2, setRef] = createSignal(null);
	const context = useResizableInternalContext();
	const [panelInstance, setPanelInstance] = createSignal(null);
	createEffect(() => ref$2(), (el) => {
		if (!el) return;
	...
	return createComponent(ResizablePanelContext, {
		value: {
			size: panelSize,
			minSize: () => p.minSize,
			maxSize: () => p.maxSize,
		...
		get children() {
			...
			spread(_el$, mergeProps({
				...
				get ["data-expanded"]() {
					return p.collapsible && !collapsed() ? "" : void 0;
				},
				get ["data-orientation"]() {
					return context.orientation();
				},
			...
			insert(_el$, (() => {
				var _c$ = memo(() => typeof p.children === "function");
				return () => _c$() ? p.children(childrenProps) : p.children;
			})());
			return _el$;
		}
	});
...
function ResizableRoot(props) {
	...
	const [ref$1, setRef] = createSignal(null);
	...
	return createComponent(ResizableContext, {
		value: ctxValue,
		get children() {
			return createComponent(ResizableInternalContext, {
