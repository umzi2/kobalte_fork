...
import { t as Meter } from "../meter/EeaTC66y.js";
...
function ProgressFill(props) {
	...
	return createComponent(Meter.Fill, mergeProps({ get style() {
		return combineStyle({ "--kb-progress-fill-width": context.progressFillWidth() }, props.style);
...
function ProgressRoot(props) {
	...
	return createComponent(ProgressContext, {
		value: context,
		get children() {
			return createComponent(Meter, mergeProps({
				role: "progressbar",
				get indeterminate() {
					return mergedProps.indeterminate || false;
				}
			}, dataset, mergedProps));
		}
	});
