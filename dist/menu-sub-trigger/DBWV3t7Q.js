...
import { a as useOptionalDomCollectionContext, n as createDomCollection, t as createDomCollectionItem } from "../create-dom-collection/F5MPGch0.js";
...
function MenuItemBase(props) {
	...
	*/
	...
	return createComponent(MenuItemContext, {
		value: context,
		get children() {
			return createComponent(Polymorphic, mergeProps({
				...
				get ["aria-disabled"]() {
					return mergedProps.disabled ? "true" : void 0;
				},
				get ["aria-labelledby"]() {
					return labelId();
				},
					...
					return createComponent(Popper.Positioner, { get children() {
						return createComponent(DismissableLayer, mergeProps({
							get disableOutsidePointerEvents() {
								return memo(() => !!isRootModalContent())() ? context.isOpen() : isRootModalContent();
							},
...
function MenuContent(props) {
	...
	return createComponent(MenuContentBase, mergeProps({ ref: [setRef, props.ref] }, others));
}
//#endregion
...
function MenuGroup(props) {
	...
	return createComponent(MenuGroupContext, {
		value: context,
		get children() {
			return createComponent(Polymorphic, mergeProps({
				as: "div",
...
function MenuItemIndicator(props) {
	...
	return createComponent(Show, {
		get when() {
			return mergedProps.forceMount || context.isChecked();
		},
		get children() {
...
function MenuRadioGroup(props) {
	...
	return createComponent(MenuRadioGroupContext, {
		value: {
...
function MenuRadioItem(props) {
	...
	return createComponent(MenuItemBase, mergeProps({
		role: "menuitemradio",
		get checked() {
			return context.isSelectedValue(mergedProps.value);
		},
		onSelect
	}, others));
}
...
function MenuRoot(props) {
	...
	return createComponent(MenuRootContext, {
		value: context,
		get children() {
