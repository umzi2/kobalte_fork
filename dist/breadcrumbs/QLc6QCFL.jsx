...
function BreadcrumbsLink(props) {
	...
	return <link_exports.Root disabled={props.disabled || props.current} aria-current={ariaCurrent()} data-current={props.current ? "" : void 0} {...others} />;
}
//#endregion
...
function BreadcrumbsRoot(props) {
	...
	const context = { separator: () => mergedProps.separator };
	return <BreadcrumbsContext value={context}>
			<Polymorphic as="nav" aria-label={mergedProps.translations.breadcrumbs} {...others} />
		</BreadcrumbsContext>;
}
//#endregion
...
function BreadcrumbsSeparator(props) {
	...
	return <Polymorphic as="span" aria-hidden="true" {...props}>
