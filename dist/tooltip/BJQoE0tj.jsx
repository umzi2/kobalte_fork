...
function TooltipContent(props) {
	...
	}, mergedProps.ref]} role="tooltip" disableOutsidePointerEvents={false} style={combineStyle({
		"--kb-tooltip-content-transform-origin": "var(--kb-popper-content-transform-origin)",
		position: "relative"
	}, mergedProps.style)} onFocusOutside={(e) => e.preventDefault()} onDismiss={() => context.hideTooltip(true)} {...context.dataset()} {...others} />
			</Popper.Positioner>
		</Show>;
}
//#endregion
...
function TooltipRoot(props) {
	...
	return <TooltipContext value={context}>
			<Popper anchorRef={triggerRef} contentRef={contentRef} onCurrentPlacementChange={(value) => {
...
function TooltipTrigger(props) {
	...
	return <Polymorphic as="button" ref={[(el) => {
		context.setTriggerRef(el);
		setRef(el);
	}, p.ref]} aria-describedby={context.isOpen() ? context.contentId() : void 0} onPointerEnter={onPointerEnter} onPointerLeave={onPointerLeave} onPointerDown={onPointerDown} onClick={onClick} onFocus={onFocus} onBlur={onBlur} {...context.dataset()} {...others} />;
}
//#endregion
