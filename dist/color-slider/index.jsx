...
import { l as useSliderContext, n as slider_exports, o as SliderInput, r as SliderValueLabel } from "../slider/Bd8zfpIR.jsx";
...
function ColorSliderRoot(props) {
	...
	return <ColorSliderContext value={context}>
			<slider_exports.Root value={[color().getChannelValue(mergedProps.channel)]} onChange={onChange} onChangeEnd={onChangeEnd} getValueLabel={getValueLabel} {...color().getChannelRange(mergedProps.channel)} {...others} />
		</ColorSliderContext>;
}
//#endregion
...
function ColorSliderThumb(props) {
	...
	return <slider_exports.Thumb style={combineStyle({
		"forced-color-adjust": "none",
		"--kb-color-current": context.value().toString()
	}, props.style)} aria-valuetext={valueText()} {...others} />;
}
//#endregion
...
function ColorSliderTrack(props) {
	...
	return <slider_exports.Track style={combineStyle({
		"forced-color-adjust": "none",
